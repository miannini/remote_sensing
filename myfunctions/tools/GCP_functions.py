...
import regex as re
import glob
os.environ["GOOGLE_APPLICATION_CREDENTIALS"]="D:/M4A/git_folder/Satellite_analysis - v2/myfunctions/tools\data-science-proj-280908-e7130591b0d5.json"
...
#usar funcion
objetos = list(list_all_blobs('data-science-proj-280908',prefix=folder,delimiter='/'))
destination = "C:/Users/Marcelo/Downloads/"
for n in objetos:
    download_blob('data-science-proj-280908', n, destination + n.split('/')[-1])
